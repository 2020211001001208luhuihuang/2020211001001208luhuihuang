			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.Luhuihuang.model.Order o=(com.Luhuihuang.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.Luhuihuang.dao.UserDao userDao=new com.Luhuihuang.dao.UserDao();
						...
						<%
							...
							String paymentType=com.Luhuihuang.model.Payment.findByPaymentId(con,n);
							 %>
