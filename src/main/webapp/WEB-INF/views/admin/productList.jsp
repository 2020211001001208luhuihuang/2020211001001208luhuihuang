	...
	<div class="container">
		...
		<div class="table-responsive col-sm-10">
			...
			<tr>
				...
				<%
					com.Luhuihuang.model.Product  p =(com.Luhuihuang.model.Product) pageContext.findAttribute("p");
					int pid = p.getProductId();
					java.sql.Connection con = (java.sql.Connection) application.getAttribute("con");
					String catName = com.Luhuihuang.model.Category.findByCategoryId(con,pid);
				%>
